...
__decorate([
    ...
    (0, class_validator_1.MaxLength)(200, { message: 'O endereço de email deve ter menos de 200 caracteres', }),
...
__decorate([
    ...
    (0, class_validator_1.MinLength)(6, { message: 'A confirmação de senha deve ter no mínimo 6 caracteres', }),
    __metadata("design:type", String)
